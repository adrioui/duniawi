---
name: sinthink
description: Design Thinking via Effect graph — X to Graph to Effect<A,E,R>. Shapes, happy-path (A), cardinality, errors (E), dependencies (R), boundary Schema, pipe behavior, scope, test layers, and gen/pipe separation. Use when designing Effect-based systems or thinking through domain modeling.
---
